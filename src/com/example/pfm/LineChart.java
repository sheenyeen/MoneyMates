...
public class LineChart extends Activity {
	...
	private void openChart() {
		...
		for(int i = 0; i < expense12months.length; i++){
			...
			expense12months[11-i] = totalExpense;
		...
		multiRenderer.setChartTitle("Expense Trend in 12 months");
	...
	private void openChart6Months() {
		...
		for(int i = 0; i < expense6months.length; i++){
			...
			expense6months[5-i] = totalExpense;
		...
		XYMultipleSeriesRenderer multiRenderer = new XYMultipleSeriesRenderer();
		multiRenderer.setXLabels(0);
		multiRenderer.setChartTitle("Expense Trend in 6 months");
		multiRenderer.setXTitle("Year " + currenttime.get(Calendar.YEAR));
		multiRenderer.setYTitle("Amount in RM");
	...
	private void openChart30Days() {
		...
		for(int i = 0; i < expense30days.length; i++){
			...
			expense30days[29-i] = totalExpense;
		...
		XYMultipleSeriesRenderer multiRenderer = new XYMultipleSeriesRenderer();
		multiRenderer.setXLabels(0);
		multiRenderer.setChartTitle("Expense Trend in 30 days");
		//multiRenderer.setXTitle("Year " + currenttime.get(Calendar.YEAR));
		multiRenderer.setYTitle("Amount in RM");
